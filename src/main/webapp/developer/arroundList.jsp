...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
    <tr>
        <td width="99%" align="left" valign="top">您的位置：环境规划图</td>
    </tr>
    <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
                <tr>
                    <td width="90%" align="left" valign="middle">
                        <form id="mainForm" method="post" action="<%=basePath%>Arround/selectAllArroundByQueryPojo.action">
                            ...
                            <div class="form-group" style="margin-top: -10px;">
                                ...
                                <select name="buildingid" class="form-control" style="height:24px; line-height:24px; width:180px; margin:8px 0 6px 0; padding:0 0px 0 10px; float:left; border:1px solid #FFF;">
                                    ...
                                    <c:forEach items="${blist}" var="b">
                                        <c:choose>
                                            <c:when test="${b.buildingid == imgQueryPojo.buildingid}">
                    ...
                    <td width="10%" align="center" valign="middle" style="text-align:right; width:150px;"><a  href="<%=basePath%>Arround/insertArroundBefore.action" target="mainFrame" onFocus="this.blur()" class="add">新增环境规划图</a></td>
                </tr>
            </table>
        </td>
    </tr>
        ...
        <td align="left" valign="top">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                <tr  onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
                    ...
                    <th  valign="middle" class="borderright">图册</th>

                    <th  valign="middle">操作</th>
                </tr>
                <c:forEach items="${pageInfo.list}" var="arround">
                    <tr id="tr_${arround.arrid}"  onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
                        <td  valign="middle" class="borderright borderbottom">${arround.arrid}</td>
                        <td  valign="middle" class="borderright borderbottom">${arround.build.building}</td>
                        <td  valign="middle" class="borderright borderbottom"><img src="${pageContext.request.contextPath}${arround.arrimg}"></td>
                        <td  valign="middle" class="borderbottom">
                            ...
                            <a href="javascript:void(0)" onclick="delArround(${arround.arrid})" target="mainFrame"  onFocus="this.blur()" class="add">删除</a>
                        </td>
                    </tr>
                </c:forEach>
    ...
    <tr>
        ...
        <script >
            ...
            function delArround(id){
                if(confirm("你确认要删除吗?")){
                    $.ajax({
                        url:"${pageContext.request.contextPath}/Arround/deleteArroundById.action",
                        type:"post",
                        data:"id="+id,
