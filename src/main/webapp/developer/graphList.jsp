...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
    <tr>
        <td width="99%" align="left" valign="top">您的位置：效果图</td>
    </tr>
    <tr>
        <td align="left" valign="top">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
                <tr>
                    ...
                    <td width="10%" align="center" valign="middle" style="text-align:right; width:150px;"><a  href="<%=basePath%>Graph/insertGraphBefore.action" target="mainFrame" onFocus="this.blur()" class="add">新增效果图</a></td>
                </tr>
            </table>
        </td>
    </tr>
    <tr>
        <td align="left" valign="top">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                ...
                <c:forEach items="${pageInfo.list}" var="graph">
                    <tr id="tr_${graph.graphid}"  onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
                        ...
                        <td  valign="middle" class="borderright borderbottom"><img width="230" height="160" src="${pageContext.request.contextPath}${graph.graphurl}"></td>
                        <td  valign="middle" class="borderbottom">
                            ...
                            <a href="javascript:void(0)" onclick="delGraph(${graph.graphid})" target="mainFrame"  onFocus="this.blur()" class="add">删除</a>
                        </td>
                    </tr>
                </c:forEach>
    ...
    <tr>
        ...
        <script >
            ...
            function delGraph(id){
                if(confirm("你确认要删除吗?")){
                    $.ajax({
                        url:"${pageContext.request.contextPath}/Graph/deleteGraphById.action",
                        type:"post",
                        data:"id="+id,
