...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
    <tr>
        <td width="99%" align="left" valign="top">您的位置： <a href="main_list.html" target="mainFrame" onFocus="this.blur()" class="add">楼盘动态</a>&nbsp;&nbsp;>&nbsp;&nbsp;编辑动态</td>
    </tr>
    <tr>
        <td align="left" valign="top" id="addinfo">
            <a href="main_list.html" target="mainFrame" onFocus="this.blur()" class="add">楼盘动态</a>
        </td>
    </tr>
    <tr>
