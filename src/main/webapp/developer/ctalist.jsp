        ...
        <td align="left" valign="top">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                ...
                <tr>
                    ...
                    <th align="center" valign="middle" class="borderright">员工号</th>
                ...
                <c:forEach items="${ctas}" var="ctas">
                    <tr id="${ctas.ctaid}_cta"  onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
                        <td align="center" valign="middle" class="borderright borderbottom"><img src="<%=imgPath%>${ctas.ctaimg}" style="width: 50px; height: 50px"></td>
                        <td align="center" valign="middle" class="borderright borderbottom">${ctas.ctaname}</td>
                        <td align="center" valign="middle" class="borderright borderbottom">${ctas.ctarelname}</td>
                        <td align="center" valign="middle" class="borderright borderbottom">${ctas.education}</td>
                        <td align="center" valign="middle" class="borderright borderbottom">${ctas.ctaphone}</td>
                        <td align="center" valign="middle" class="borderbottom">
                            <a href="${pageContext.request.contextPath}/cta/showDetial.action?ctaid=${ctas.ctaid}" target="mainFrame" onFocus="this.blur()" class="add">详情</a>
                            <a href="${pageContext.request.contextPath}/cta/updatecta.action?ctaid=${ctas.ctaid}" target="mainFrame" onFocus="this.blur()" class="add">|修改</a>
                            |<a href="javascript:void(0)" onclick="remove('${ctas.ctaid}')" target="mainFrame" onFocus="this.blur()" class="add">删除</a>
...
<script type="text/javascript">
    ...
    function remove(id) {
        if (confirm("确定要删除么？")){
            var url="${pageContext.request.contextPath}/cta/deleteCta.action";
            $.get(url,"ctaid="+id,function(data){
