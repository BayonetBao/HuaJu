...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
    <tr>
        <td width="99%" align="left" valign="top">您的位置：样板间</td>
    </tr>
    <tr>
        <td align="left" valign="top">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
                <tr>
                    ...
                    <td width="10%" align="center" valign="middle" style="text-align:right; width:150px;"><a  href="<%=basePath%>ProtoType/inserProtoTypetBefore.action" target="mainFrame" onFocus="this.blur()" class="add">新增样板间</a></td>
                </tr>
            </table>
        </td>
    </tr>
    <tr>
        <td align="left" valign="top">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                ...
                <c:forEach items="${pageInfo.list}" var="proto">
                    <tr id="tr_${proto.proid}"  onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
                        <td  valign="middle" class="borderright borderbottom">${proto.proid}</td>
                        <td  valign="middle" class="borderright borderbottom">${proto.build.building}</td>
                        <td  valign="middle" class="borderright borderbottom"><img width="230" height="160" src="${pageContext.request.contextPath}${proto.prototype}"></td>
                        <td  valign="middle" class="borderbottom">
                            ...
                            <a href="javascript:void(0)" onclick="delProto(${proto.proid})" target="mainFrame"  onFocus="this.blur()" class="add">删除</a>
                        </td>
                    </tr>
                </c:forEach>
    ...
    <tr>
        ...
        <script >
            ...
            function delProto(id){
                if(confirm("你确认要删除吗?")){
                    $.ajax({
                        url:"${pageContext.request.contextPath}/ProtoType/deleteProtoTypeById.action",
                        type:"post",
                        data:"id="+id,
