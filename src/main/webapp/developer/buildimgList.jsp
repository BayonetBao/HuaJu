...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
    <tr>
        <td width="99%" align="left" valign="top">您的位置：楼盘实景图</td>
    </tr>
    <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
                <tr>
                    <td width="90%" align="left" valign="middle">
                        <form id="mainForm" method="post" action="<%=basePath%>Buildimg/selectAllBuildimgByQueryPojo.action">
                    ...
                    <td width="10%" align="center" valign="middle" style="text-align:right; width:150px;"><a  href="<%=basePath%>Buildimg/insertBuildimgBefore.action" target="mainFrame" onFocus="this.blur()" class="add">新增楼盘实景图</a></td>
                </tr>
            </table>
        </td>
    </tr>
    <tr>
        <td align="left" valign="top">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                ...
                <c:forEach items="${pageInfo.list}" var="buildimg">
    ...
    <tr>
        ...
        <script >
            ...
            function delBuildimg(id){
                if(confirm("你确认要删除吗?")){
                    $.ajax({
                        url:"${pageContext.request.contextPath}/Buildimg/deleteBuildimgById.action",
                        type:"post",
                        data:"id="+id,
