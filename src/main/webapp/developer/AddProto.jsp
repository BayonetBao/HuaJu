...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
    <tr>
        <td width="99%" align="left" valign="top">您的位置：样板间&nbsp;&nbsp;>&nbsp;&nbsp;新增样板间</td>
    </tr>
    <tr>
    ...
    <tr>
        <td align="left" valign="top">
            <form method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/ProtoType/insertProtoTypeAfter.action" name="upload" id="upload">
