...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
    <tr>
        <td width="99%" align="left" valign="top">您的位置：配套实景图</td>
    </tr>
    <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
                <tr>
                    <td width="90%" align="left" valign="middle">
                        <form id="mainForm" method="post" action="<%=basePath%>Environment/selectAllEnvirByQueryPojo.action">
                    ...
                    <td width="10%" align="center" valign="middle" style="text-align:right; width:150px;"><a  href="<%=basePath%>Environment/insertEnvirBefore.action" target="mainFrame" onFocus="this.blur()" class="add">新增配套实景图</a></td>
                </tr>
            </table>
        </td>
    </tr>
    <tr>
        <td align="left" valign="top">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                ...
                <c:forEach items="${pageInfo.list}" var="envir">
                    <tr id="tr_${envir.envirid}"  onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
                        ...
                        <td  valign="middle" class="borderbottom">
                            ...
                            <a href="javascript:void(0)" onclick="delEnvir(${envir.envirid})" target="mainFrame"  onFocus="this.blur()" class="add">删除</a>
                        </td>
                    </tr>
                </c:forEach>
    ...
    <tr>
        ...
        <script >
            ...
            function delEnvir(id){
                if(confirm("你确认要删除吗?")){
                    $.ajax({
                        url:"${pageContext.request.contextPath}/Environment/deleteEnvirById.action",
                        type:"post",
                        data:"id="+id,
