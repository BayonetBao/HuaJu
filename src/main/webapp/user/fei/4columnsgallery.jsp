					...
					<!---Brand and toggle get grouped for better mobile display--->
						<div class="navbar-header">
							...
							<div class="navbar-brand">
								<h1><a href="index.html"><span>华居</span></a></h1>
							</div>
						</div>
			...
			<!-- Collect the nav links, forms, and other content for toggling -->
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
								<li class="active"><a href="index.html">楼盘主页<span class="sr-only">(current)</span></a></li>
								<li class="dropdown"><a href="forrent.html">户型分析</a></li>
								<li><a href="blog.html">楼盘动态</a></li>
								<li><a href="contact.html">楼盘点评</a></li>
								<li><a href="blog.html">楼盘图册</a></li>
								<li><a href="contact.html">楼盘详情</a></li>
							</ul>
