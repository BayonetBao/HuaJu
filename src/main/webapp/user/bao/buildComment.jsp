...
<nav class="navbar-default" style="background-color:#f8f8f8;overflow:auto; min-width:1125px;">
    ...
    <ul class="nav navbar-nav" style="float:none; margin:0px auto; width:1120px;">
        ...
        <li style="margin-right:57px;"class="active"><a href="${pageContext.request.contextPath}/comment/selectAllCommentByQueryPojoFront.action?buildingid=${build.buildingid}" style="color: #0b0b0b;">楼盘评论</a></li>
