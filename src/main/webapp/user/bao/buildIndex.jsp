            ...
            <div class="properties-grids">
                <div class="col-md-9 properties-left">
                    ...
                    <div class="note" style="border: solid cornsilk 1px;width:1040px;padding-bottom: 10px;">
                        ...
                        <c:forEach items="${houseList}" var="house">
                            <div style="border:solid rgba(116,117,112,0.93) 1px; height: 200px;overflow: auto;">
                                ...
                                <div style="float:left;border: solid chartreuse 1px;margin-top:18px; margin-left:80px;height: 160px;width: 575px;">
                                    <b style="font-size:24px;">${house.hname}</b>&nbsp;&nbsp;&nbsp;&nbsp;<span
                                        style="border: solid rgba(251,97,95,1) 1px; color:#ff6d6f;">${house.hsalestatus}</span>
                                    <br>
                                    <br>
                    ...
                    <div class="note" style="border: solid cornsilk 1px;padding-bottom: 10px;">
                        <iframe src="${pageContext.request.contextPath}/dynamic/selectDynamicByBuild.action?buildingid=${build.buildingid}"
                                name="myframe" width='100%' height='100%' frameborder='0' id="myframe">
                        </iframe>
                    </div>
                    <%--楼盘周边--%>
                ...
                <div class="col-md-3 properties-right">
                    <div class="properties-top">
                        ...
                        <ul class="">
                            <li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i> Office : 0041-456-3692
                            </li>
                        ...
                        <p>Lorem agent info ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh
                            euismod tincidunt ut laoreet magna…</p>
