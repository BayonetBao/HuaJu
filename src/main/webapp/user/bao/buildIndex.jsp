...
<nav class="navbar-default" style="background-color:#f8f8f8;overflow:auto; min-width:1125px;">
    ...
    <ul class="nav navbar-nav" style="float:none; margin:10px auto; width:1120px;">
        ...
        <li style="margin-right:57px;"><a href="#comment" style="color: #0b0b0b;">楼盘评论</a></li>
                ...
                <div class="col-md-9 properties-left">
                    ...
                    <div class="note" style="border: solid cornsilk 1px;padding-bottom: 10px;width: 1045px;">
                        ...
                        <div style="width:100%;overflow: auto;">
                            ...
                            <div style=" background-color:cornsilk;width:455px;height:565px;border:solid crimson 1px;float:left;" id="r-result">
